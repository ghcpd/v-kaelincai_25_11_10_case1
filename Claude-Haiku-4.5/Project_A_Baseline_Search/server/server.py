"""
Project A - Baseline Search Server
Lightweight Flask server to serve the baseline search application
"""
...
@app.route('/')
def index():
    """Serve the baseline search application"""
...
if __name__ == '__main__':
    ...
    log_request(f"Starting Project A server on port {port}")
